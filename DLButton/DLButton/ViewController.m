...
//  DLButton
//
//  Created by ysb on 2017/7/24.
//  Copyright © 2017年 ysb. All rights reserved.
//
...
@property (weak, nonatomic) IBOutlet DLButton *xibBtn;
@property (weak, nonatomic) IBOutlet DLButton *titleInsideImage;
...
- (void)viewDidLoad {
    ...
    {
        DLButton * searchBtn = [DLButton buttonWithType:UIButtonTypeCustom];
    ...
    {
        DLButton * cancelBtn = [DLButton buttonWithType:UIButtonTypeCustom];
